...
class EventHandler(FileSystemEventHandler):
    ...
    def on_modified(self, event):
        for child in self.watch_path.iterdir():
            ...
            if child.is_file() and child.suffix.lower() in extensions.extension_paths:
                destination_path = self.destination_root / extensions.extension_paths[child.suffix.lower()]
